...
predicts gated selectivity and, for an action that converts both states
alike, unsteered answers give the selectivity ceiling of a decision. On overconfident multiple-choice reasoning with Gemma-2-2B, PTS
...
\item In the setting of PCHI, PTS with the same probe is more selective than
PCHI's learned rescaling of attention heads
...
probe and replaces the learned rescaling with a shift of the same state
strong enough to convert every flagged answer. On 3{,}183 held-out answers it reaches selectivity $0.438$,
