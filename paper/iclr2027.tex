...
\end{axis}
\end{tikzpicture}
\caption{\textbf{Gated edits are ordered by the held-out quality of their
decision, and overriding the readout with the same decision is as selective.}
...
fires too rarely on ARC-Challenge (Appendix~\ref{app:transfer}), and
without out-of-domain negatives it fires on open-ended instructions
(Appendix~\ref{app:capability}). Third, the transport characterisation fixes the
