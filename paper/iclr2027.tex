...
evaluated. A gated edit should be compared not only with global steering but
with detect-and-override under the same decision, and the identity says in
advance when it can win: only if the action spares the protected answers the
