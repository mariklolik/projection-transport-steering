# Aggregate the multi-seed runs: mean +- std over eval-subset seeds for the
...
# sampling-seed robustness. Writes paper/gen/multiseed_table.tex (2B) and
# paper/gen/table_9b.tex (9B replication).
